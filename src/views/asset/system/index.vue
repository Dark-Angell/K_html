        ...
        <el-form :model="queryParams" label-width="80px" inline>
          ...
          <el-form-item label="业务类型">
            <el-select
              ...
              style="width: 200px"
            >
              <el-option label="业务类型1" value="1" />
              <el-option label="业务类型2" value="2" />
            </el-select>
          </el-form-item>
...
const availableColumns = ref([
  { prop: 'name', label: '系统名称', minWidth: '120px' },
  { prop: 'businessType', label: '业务类型', minWidth: '120px' },
  { prop: 'unit', label: '所属单位', minWidth: '120px' },
  { prop: 'systemType', label: '系统类型', minWidth: '120px' },
  { prop: 'version', label: '系统版本', minWidth: '100px' },
  {
    prop: 'tags',
    label: '系统标签',
  ...
  { prop: 'onlineTime', label: '上线时间', minWidth: '120px' },
  { prop: 'serviceObject', label: '服务对象', minWidth: '120px' },
  { prop: 'userScale', label: '用户规模', minWidth: '120px' },
  { prop: 'isCritical', label: '是否关机', minWidth: '100px' },
  { prop: 'isWebsite', label: '是否网站类系统', minWidth: '150px' },
  { prop: 'isExposed', label: '是否互联网暴露', minWidth: '150px' },
  { prop: 'securityLevel', label: '等保级别', minWidth: '100px' },
  { prop: 'ipPorts', label: 'IP端口列表', minWidth: '150px' },
  { prop: 'screenshot', label: '系统截图', minWidth: '120px' },
  { prop: 'description', label: '系统描述', minWidth: '200px' },
  { prop: 'roomLocation', label: '机房位置', minWidth: '120px' },
  { prop: 'rackLocation', label: '机柜位置', minWidth: '120px' },
  { prop: 'uPosition', label: 'U位信息', minWidth: '100px' },
  { prop: 'networkArea', label: '网络区域', minWidth: '100px' }
])
