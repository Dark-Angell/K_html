  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="设备IP" align="center" prop="mobile" width="120" />
      <el-table-column label="所属机房" align="center" prop="mobile" width="120" />
...
/** 详情操作 */
const handleDetail = (row: unitApi.UnitVO) => {
  router.push({
    name: 'UnitDetail',
    query: {
      id: row.id
