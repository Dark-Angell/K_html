<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="IP网段" prop="name">
        <el-input
          v-model="queryParams.name"
          placeholder="请输入"
          clearable
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="IP范围" align="center" prop="mobile" width="120" />
      <el-table-column label="标签" align="center" prop="mobile" width="120" />
